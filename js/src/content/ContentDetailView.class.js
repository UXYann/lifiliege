...
ContentDetailView.prototype.displayItem = function(){
    ...
    if(lang=="fr"){
        ...
        //document.getElementsByClassName('artWorkTitleDetailed')[0].innerHTML = this.hotSpotController.model.current['oeuvre'][0]['textes']['FR']['titreOeuvre'];
        $('.artworkTitle').html(this.hotSpotController.model.current['oeuvre'][0]['textes']['FR']['titreOeuvre']);
        //document.getElementsByClassName('artworkLinksDetailed')[0].innerHTML = this.hotSpotController.model.current['oeuvre'][0]['textes']['FR']['descriptionOeuvre'];
...
ContentDetailView.prototype.onZoomLauncher = function() {
    ...
    jQuery('.si-icon-maximize-rotate').click();
        ...
        var artWork;
        if(this.hotSpotController.model.current) {
            artWork = this.hotSpotController.model.current['oeuvre'][0]['image'];
        } else {
